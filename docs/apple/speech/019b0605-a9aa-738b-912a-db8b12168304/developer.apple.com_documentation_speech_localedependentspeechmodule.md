...
title: "LocaleDependentSpeechModule | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/documentation/speech/localedependentspeechmodule#app-main)

- [Global Nav Open Menu](https://developer.apple.com/documentation/speech/localedependentspeechmodule#ac-gn-menustate) [Global Nav Close Menu](https://developer.apple.com/documentation/speech/localedependentspeechmodule#)
...
[Open Menu](https://developer.apple.com/documentation/speech/localedependentspeechmodule#)
...
1 of 5 symbols inside -491077142
...
2 of 5 symbols inside -491077142 [static var supportedLocales: \[Locale\]](https://developer.apple.com/documentation/speech/localedependentspeechmodule/supportedlocales)

To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow

M

3 of 5 symbols inside -491077142 [static func supportedLocale(equivalentTo: Locale) async -> Locale?](https://developer.apple.com/documentation/speech/localedependentspeechmodule/supportedlocale(equivalentto:))

To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow

4 of 5 symbols inside -491077142
...
5 of 5 symbols inside -491077142 [var selectedLocales: \[Locale\]](https://developer.apple.com/documentation/speech/localedependentspeechmodule/selectedlocales)
...
## [Topics](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#topics)

### [Getting supported locales](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#Getting-supported-locales)

[`static var supportedLocales: [Locale]`](https://developer.apple.com/documentation/speech/localedependentspeechmodule/supportedlocales)

The set of all possible asset locales that the module supports.

**Required**

[`static func supportedLocale(equivalentTo: Locale) async -> Locale?`](https://developer.apple.com/documentation/speech/localedependentspeechmodule/supportedlocale(equivalentto:))

A locale from the module’s supported locales equivalent to the given locale.

**Required**

### [Inspecting an instance’s locales](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#Inspecting-an-instances-locales)

[`var selectedLocales: [Locale]`](https://developer.apple.com/documentation/speech/localedependentspeechmodule/selectedlocales)

The set of asset locales specified by the module’s configuration.

**Required**

## [Relationships](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#relationships)

### [Inherits From](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#inherits-from)

- [`Sendable`](https://developer.apple.com/documentation/Swift/Sendable)
- [`SendableMetatype`](https://developer.apple.com/documentation/Swift/SendableMetatype)
- [`SpeechModule`](https://developer.apple.com/documentation/speech/speechmodule)

### [Conforming Types](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#conforming-types)

- [`DictationTranscriber`](https://developer.apple.com/documentation/speech/dictationtranscriber)
- [`SpeechTranscriber`](https://developer.apple.com/documentation/speech/speechtranscriber)

## [See Also](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#see-also)

### [Modules](https://developer.apple.com/documentation/speech/localedependentspeechmodule\#Modules)
...
[`protocol SpeechModule`](https://developer.apple.com/documentation/speech/speechmodule)

Protocol that all analyzer modules conform to.

Current page is LocaleDependentSpeechModule
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fspeech%2Flocaledependentspeechmodule).
