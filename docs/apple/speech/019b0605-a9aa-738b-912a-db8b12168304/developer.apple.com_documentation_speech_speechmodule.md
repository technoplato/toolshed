...
title: "SpeechModule | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/documentation/speech/speechmodule#app-main)

- [Global Nav Open Menu](https://developer.apple.com/documentation/speech/speechmodule#ac-gn-menustate) [Global Nav Close Menu](https://developer.apple.com/documentation/speech/speechmodule#)
...
[Open Menu](https://developer.apple.com/documentation/speech/speechmodule#)
...
1 of 6 symbols inside -2145162388
...
2 of 6 symbols inside -2145162388 [var availableCompatibleAudioFormats: \[AVAudioFormat\]](https://developer.apple.com/documentation/speech/speechmodule/availablecompatibleaudioformats)

To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow

3 of 6 symbols inside -2145162388
...
4 of 6 symbols inside -2145162388 [var results: Self.Results](https://developer.apple.com/documentation/speech/speechmodule/results-swift.property)

To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow

Collection

5 of 6 symbols inside -2145162388 [Result](https://developer.apple.com/documentation/speech/speechmodule/result)

To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow

Collection

6 of 6 symbols inside -2145162388 [Results](https://developer.apple.com/documentation/speech/speechmodule/results-swift.associatedtype)
...
## [Topics](https://developer.apple.com/documentation/speech/speechmodule\#topics)

### [Checking audio format support](https://developer.apple.com/documentation/speech/speechmodule\#Checking-audio-format-support)

[`var availableCompatibleAudioFormats: [AVAudioFormat]`](https://developer.apple.com/documentation/speech/speechmodule/availablecompatibleaudioformats)

The audio formats that this module is able to analyze, given its configuration.

**Required**

### [Getting results](https://developer.apple.com/documentation/speech/speechmodule\#Getting-results)

[`var results: Self.Results`](https://developer.apple.com/documentation/speech/speechmodule/results-swift.property)

An asynchronous sequence containing this module’s analysis results. Results are added to the sequence as they are created.

**Required**

[`associatedtype Result : SpeechModuleResult, Sendable`](https://developer.apple.com/documentation/speech/speechmodule/result)

**Required**

[`associatedtype Results : Sendable, AsyncSequence`](https://developer.apple.com/documentation/speech/speechmodule/results-swift.associatedtype)

**Required**

## [Relationships](https://developer.apple.com/documentation/speech/speechmodule\#relationships)

### [Inherits From](https://developer.apple.com/documentation/speech/speechmodule\#inherits-from)

- [`Sendable`](https://developer.apple.com/documentation/Swift/Sendable)
- [`SendableMetatype`](https://developer.apple.com/documentation/Swift/SendableMetatype)

### [Inherited By](https://developer.apple.com/documentation/speech/speechmodule\#inherited-by)

- [`LocaleDependentSpeechModule`](https://developer.apple.com/documentation/speech/localedependentspeechmodule)

### [Conforming Types](https://developer.apple.com/documentation/speech/speechmodule\#conforming-types)
...
## [See Also](https://developer.apple.com/documentation/speech/speechmodule\#see-also)

### [Modules](https://developer.apple.com/documentation/speech/speechmodule\#Modules)

[`class SpeechTranscriber`](https://developer.apple.com/documentation/speech/speechtranscriber)

A speech-to-text transcription module that’s appropriate for normal conversation and general purposes.

[`class DictationTranscriber`](https://developer.apple.com/documentation/speech/dictationtranscriber)

A speech-to-text transcription module that’s similar to system dictation features and compatible with older devices.

[`class SpeechDetector`](https://developer.apple.com/documentation/speech/speechdetector)

A module that performs a voice activity detection (VAD) analysis.

[`protocol LocaleDependentSpeechModule`](https://developer.apple.com/documentation/speech/localedependentspeechmodule)

A module that requires locale-specific assets.

Current page is SpeechModule
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fspeech%2Fspeechmodule).
