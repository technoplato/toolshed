...
class BaseEntity(BaseModel):
    id: Optional[str] = None # Optional, generated by DB/Repo if missing
...
class DiarizationSegment(BaseSegment):
    speaker_id: str
    confidence: Optional[float] = None
    embedding_id: Optional[str] = None # Link to Postgres Vector
...
class TranscriptionRun(BaseEntity):
    video_id: str
    config_id: Optional[str] = None # Link to config
    config: Optional[TranscriptionConfig] = None # Embedded for convenience during save
